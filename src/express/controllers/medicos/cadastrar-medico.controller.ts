...
import { CadastrarMedicoService } from '../../../application/domains/medico/cadastrar/cadastrar-medico.service'
import { MedicoRepository } from '../../../repositories/medico.repository'
import { CadastrarMedicoDto } from '../../../application/domains/medico/cadastrar/dto/cadastrar-medico.dto'
